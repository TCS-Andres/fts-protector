          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-36 pb-16 sm:pt-44 lg:pt-32 w-full">
            <div className="max-w-3xl">
              ...
              <h1 className="hero-animate hero-animate-2 font-heading text-[44px] sm:text-6xl lg:text-7xl font-bold uppercase leading-[0.95] text-white mb-6">
                Tools &amp; Knowledge
                <br />
                <span className="text-accent-gold">That Protect.</span>
              </h1>
              ...
              {products.map((p) => (
                ...
                >
                  <div className="aspect-[4/3] relative overflow-hidden">
                    ...
                    <span className="absolute top-4 left-4 inline-flex items-center px-3 py-1.5 bg-black/60 backdrop-blur border border-accent-gold/40 rounded-full text-accent-gold text-[10px] uppercase tracking-[2px] font-bold font-body">
                      {p.kicker}
                    </span>
                    {p.status === "soon" && (
                      <span className="absolute top-4 right-4 inline-flex items-center px-3 py-1.5 bg-accent-red text-white rounded-full text-[10px] uppercase tracking-[2px] font-bold font-body">
                        Coming Soon
                      </span>
                    )}
                  </div>
                  <div className="p-6 sm:p-8 flex flex-col flex-1">
                    ...
                    {p.status === "live" && p.href ? (
                      <a
                        ...
                        className="inline-flex items-center justify-center px-6 py-3 bg-accent-gold text-black text-sm font-bold uppercase tracking-[2px] rounded hover:bg-white transition-colors duration-300"
                      >
                        {p.cta} &rarr;
                      </a>
                    ) : (
